...
#ifndef PROTOBUF_laik_5fext_2eproto__INCLUDED
#define PROTOBUF_laik_5fext_2eproto__INCLUDED
...
class laik_ext_msg : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:laik_ext_msg) */ {
 public:
  ...
  #if LANG_CXX11
  laik_ext_msg(laik_ext_msg&& from) noexcept
    : laik_ext_msg() {
    *this = ::std::move(from);
  }

  inline laik_ext_msg& operator=(laik_ext_msg&& from) noexcept {
  ...
  friend void swap(laik_ext_msg& a, laik_ext_msg& b) {
    a.Swap(&b);
  }
 ...
 private:
  ...
  friend struct ::protobuf_laik_5fext_2eproto::TableStruct;
  friend void ::protobuf_laik_5fext_2eproto::InitDefaultslaik_ext_msgImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_laik_5fext_2eproto__INCLUDED
